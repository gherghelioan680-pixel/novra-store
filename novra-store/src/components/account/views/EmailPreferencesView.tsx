    ...
    <div>
      ...
      <div className="space-y-4 rounded-xl border border-white/10 bg-novra-card/30 p-5">
        <label className="flex items-center justify-between gap-4">
          <span className="text-sm text-gray-300">Oferte și promoții</span>
          <input
            type="checkbox"
        ...
        <label className="flex items-center justify-between gap-4">
          <span className="text-sm text-gray-300">Status comenzi</span>
          <input
            type="checkbox"
        ...
        <label className="flex items-center justify-between gap-4">
          <span className="text-sm text-gray-300">Recomandări personalizate</span>
          <input
            type="checkbox"
